...
public class TechnologyFragment extends Fragment {
    ...
    Adapter adapter;
    String country = "in";
    private RecyclerView recycleroftech;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recycleroftech = v.findViewById(R.id.recyclerview_Technology);
        modelClassArrayList=new ArrayList<>();
        recycleroftech.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter = new Adapter(getContext(),modelClassArrayList);
        recycleroftech.setAdapter(adapter);
