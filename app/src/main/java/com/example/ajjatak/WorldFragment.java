...
public class WorldFragment extends Fragment {
    ...
    Adapter adapter;
    String country = "in";
    private RecyclerView recyclerofworld;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerofworld = v.findViewById(R.id.recyclerview_World);
        modelClassArrayList=new ArrayList<>();
        recyclerofworld.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter = new Adapter(getContext(),modelClassArrayList);
        recyclerofworld.setAdapter(adapter);
