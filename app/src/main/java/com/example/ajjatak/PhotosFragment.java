...
public class PhotosFragment extends Fragment {
    ...
    Adapter adapter;
    String country = "in";
    private RecyclerView recyclerofphotos;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerofphotos = v.findViewById(R.id.recyclerview_Photos);
        modelClassArrayList=new ArrayList<>();
        recyclerofphotos.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter = new Adapter(getContext(),modelClassArrayList);
        recyclerofphotos.setAdapter(adapter);
